...
// KESİN YAPILANDIRMA: Hardcoded kategoriler
const CATEGORIES = ['PDF', 'Image', 'Video', 'Converter', 'AI Writing', 'Other'];

const tools = [
  // PDF Tools
  { title: "Rotate PDF", desc: "Rotate PDF online", cat: "PDF", icon: <RefreshCw className="w-5 h-5 text-blue-500" />, link: "/tools/rotate-pdf" },
  { title: "Add Watermark", desc: "Add Watermark to PDF", cat: "PDF", icon: <Type className="w-5 h-5 text-indigo-500" />, link: "/tools/add-watermark" },
  { title: "PDF to Text", desc: "Convert PDF to Text", cat: "PDF", icon: <FileText className="w-5 h-5 text-orange-500" />, link: "/tools/pdf-to-text" },
  { title: "PDF to Word", desc: "Convert PDF to Word", cat: "PDF", icon: <FileText className="w-5 h-5 text-blue-600" />, link: "/tools/pdf-to-word" },
  { title: "PDF to JPG", desc: "Convert PDF to JPG", cat: "PDF", icon: <ImageIcon className="w-5 h-5 text-pink-500" />, link: "/tools/pdf-to-jpg" },
  { title: "PDF to Excel", desc: "Convert PDF to Excel", cat: "PDF", icon: <FileText className="w-5 h-5 text-green-600" />, link: "/tools/pdf-to-excel" },
  { title: "PDF to PPT", desc: "Convert PDF to PPT", cat: "PDF", icon: <Presentation className="w-5 h-5 text-orange-600" />, link: "/tools/pdf-to-powerpoint" },
  { title: "Word to PDF", desc: "Convert Word to PDF", cat: "PDF", icon: <FileText className="w-5 h-5 text-blue-500" />, link: "/tools/word-to-pdf" },
  { title: "JPG to PDF", desc: "Convert JPG to PDF", cat: "PDF", icon: <ImageIcon className="w-5 h-5 text-red-500" />, link: "/tools/jpg-to-pdf" },
  { title: "Merge PDF", desc: "Combine multiple PDF", cat: "PDF", icon: <Zap className="w-5 h-5 text-yellow-500" />, link: "/tools/merge-pdf" },
  { title: "Split PDF", desc: "Split PDF file", cat: "PDF", icon: <Scissors className="w-5 h-5 text-purple-500" />, link: "/tools/split-pdf" },
  { title: "Compress PDF", desc: "Reduce PDF size", cat: "PDF", icon: <Minimize className="w-5 h-5 text-emerald-500" />, link: "/tools/compress-pdf" },
  { title: "Edit PDF", desc: "Free PDF editor", cat: "PDF", icon: <PenTool className="w-5 h-5 text-sky-500" />, link: "/tools/edit-pdf" },
  { title: "Unlock PDF", desc: "Remove PDF password", cat: "PDF", icon: <Lock className="w-5 h-5 text-rose-500" />, link: "/tools/remove-password" },
  { title: "Protect PDF", desc: "Encrypt PDF file", cat: "PDF", icon: <Lock className="w-5 h-5 text-gray-700" />, link: "/tools/protect-pdf" },
  ...
  { title: "Excel to PDF", desc: "Excel to PDF converter", cat: "Converter", icon: <FileText className="w-5 h-5 text-green-600" />, link: "/tools/excel-to-pdf" },
